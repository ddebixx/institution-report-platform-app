  ...
  return (
    <div className="relative flex min-h-[calc(100vh-200px)] items-center justify-center overflow-hidden bg-gradient-to-b from-background via-background to-muted/20 px-4 py-16 sm:px-6">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/5 blur-3xl animate-pulse"
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute top-40 right-20 h-3 w-3 rounded-full bg-primary/20 animate-float-delayed"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute bottom-32 left-1/4 h-2 w-2 rounded-full bg-primary/25 animate-float"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-20 right-1/3 h-3 w-3 rounded-full bg-primary/20 animate-float-delayed"
                  ...
                  <div className="mb-6 flex items-center justify-center gap-4">
                    <div className="relative">
                      ...
                      <div className="relative rounded-2xl border border-primary/30 bg-primary/10 px-8 py-6 backdrop-blur-sm">
                        <span className="text-7xl font-bold text-primary sm:text-8xl lg:text-9xl">
                          4
                        </span>
                      </div>
                    </div>
